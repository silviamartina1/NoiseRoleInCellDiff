...
plt.annotate(r"$K_{\textrm{max}}$",xy=(25.,35),xytext=(K_max-3,-15),fontsize=22)
plt.rc('font', size=22)
plt.xlabel(r'$K$',fontsize=22)
plt.ylabel(r'\textrm{Concentration} $Y$',fontsize=22)
plt.title(r'$\textrm{Bifurcation} \, \, \textrm{diagram}$',fontsize=25)
...
plt.title(r'$\textit{Steady states nature}$',fontsize=15)

plt.xlabel(r'$K$',fontsize=15)
plt.ylabel("X-Concentration ",fontsize=15)

black_patch = mpatches.Patch(color='black', label=r'\textit{Unstable Points (Not Asymptotically)}')
grey_patch = mpatches.Patch(color='grey', label=r'\textit{ Stable Points (Not Asymptotically)}')
red_patch = mpatches.Patch(color='red', label=r' \textit{Null Cycle}')
orange_patch = mpatches.Patch(color='orange', label=r' \textit{Unstable Points}')
